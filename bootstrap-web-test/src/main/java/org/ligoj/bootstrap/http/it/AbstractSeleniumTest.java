 ...
 */
abstract class AbstractSeleniumTest extends AbstractSeleniumQueryTest {
	 ...
	 */
    void assertUrl(final String url) {
	 ...
	 *            Id of the select2
	 */
    void assertSelect2Values(final String expectedValues, final String select2Id) {
	 ...
	 */
    String arrayToString(final List<String> elements) {
	 ...
	 *            Input Id
	 */
    void assertDomInputValue(final String expectedText, final String inputId) {
	 ...
	 *            Input location
	 */
    void assertInputValue(final String expectedText, final By by) {
	 ...
	 *            Table column.
	 */
    void assertCellError(final String expectedError, final String tableId, final int row, final int column) {
	 ...
	 *            Table column.
	 */
    void assertCellText(final String expectedText, final String tableId, final int row, final int column) {
		new WebDriverWait(driver, timeout).until(d -> {
			try {
	 ...
	 *            Expected error text (Helper.ERROR_*)
	 */
    void assertFieldError(final String expectedError, final String elementId) {
		new WebDriverWait(driver, timeout).until(d -> {
			try {
	 ...
	 */
    void assertElementAttribute(final String expectedAttributeValue, final By by, final String attribute) {
	 ...
	 *            Waiting value
	 */
    void assertElementText(final String expectedText, final By by) {
		new WebDriverWait(driver, timeout).until(d -> {
			try {
	 ...
	 *            Element to wait for
	 */
    void assertElementHidden(final By by) {
		new WebDriverWait(driver, timeout).until(d -> {
			try {
